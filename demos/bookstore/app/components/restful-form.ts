...
import { component, form, input } from '../renuel.ts'
 ...
 * the request.
 */
export const { RestfulForm, RestfulForm$ } = component(
  'RestfulForm',
  ({ children, method = 'GET', methodOverrideField = '_method', ...props }: RestfulFormProps) => {
